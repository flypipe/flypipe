    ...
    return (
        ...
        <Modal.Body>
          <ul className='list-unstyled'>
            ...
            <li>
            Location: 
              <CopyToClipboard text={node.filePath} className="ms-2 pointer fst-italic text-secondary bg-opacity-10" onCopy={() => {
            ...
            <li>
              Py Import: 
              <CopyToClipboard text={node.pythonImportCommand} className="ms-2 pointer fst-italic text-secondary bg-opacity-10" onCopy={() => {
          ...
          <CopyToClipboard text={node.sourceCode} className="ms-2" onCopy={() => {
                ...
                <span>
                  ...
                  >
                    <Button variant="light" className="btn-sm position-absolute ms-n2 mt-2 "><BsClipboard /></Button>
                  </OverlayTrigger>
