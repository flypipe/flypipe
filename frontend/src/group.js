                        ...
                        internalTargetNodes.forEach(( internalTargetNode ) => {
                            internalTargetNode.data.predecessors.forEach(( predecessorNodeId ) => {
                                if (predecessorNodeId == source_node.id){
                                    ...
                                    .forEach((edge) => {
//                                        console.log("case 1.5:", predecessorNodeId, "--->", internalTargetNode.id);
                                        edge.hidden = true;
                                    });
                        ...
                        internalTargetNodes.forEach(( internalTargetNode ) => {
                            internalTargetNode.data.predecessors.forEach(( predecessorNodeId ) => {
                                if (predecessorNodeId == source_node.id){
                                    ...
                                    .forEach((edge) => {
//                                        console.log("case 2.1:", predecessorNodeId, "--->", internalTargetNode.id);
                                        edge.hidden = false;
                                    });
