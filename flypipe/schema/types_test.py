...
class TestDate:
    ...
    @pytest.mark.parametrize('python_format,expected_pyspark_format', [
        ('%Y', 'yyyy'),
        ('%y', 'yy'),
        ('%j', 'yyy'),
        ('%b', 'MMM'),
    ...
    def test_convert_python_to_pyspark_datetime_format(self, python_format, expected_pyspark_format):
    ...
    @pytest.mark.parametrize('pyspark_format,expected_python_format', [
        ('yyyy', '%Y'),
        ('yy', '%y'),
        ('yyy', '%j'),
        ('MMM', '%b'),
    ...
    def test_convert_pyspark_to_python_datetime_format(self, pyspark_format, expected_python_format):
