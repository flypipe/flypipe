...
class TestCatalogCore:
    ...
    def test_node_successor(self):
        ...
        assert sorted(
            ...
            (
                "t1",
                [
                    "flypipe_catalog_catalog_core_test_function_t2_t2",
                    "flypipe_catalog_catalog_core_test_function_t3_t3",
                ],
            ),
            ("t2", []),
            ("t3", []),
    ...
    def test_node_successor_duplicate(self):
        ...
        ) == [("t1", ["flypipe_catalog_catalog_core_test_function_t2_t2"]), ("t2", [])]
    ...
    def test_get_nodes(self):
        ...
        assert catalog.get_nodes() == [
            {
                "description": "Description for t2",
                "filePath": str(Path("flypipe/catalog/catalog_core_test.py")),
                "importCmd": "from flypipe.catalog.catalog_core_test import t2",
                "nodeKey": "flypipe_catalog_catalog_core_test_function_t2_t2",
                "nodeType": "pandas",
                "name": "t2",
                "predecessors": ["flypipe_catalog_catalog_core_test_function_t1_t1"],
                "predecessorColumns": {
                    "flypipe_catalog_catalog_core_test_function_t1_t1": ["c2", "c3"]
                },
                "predecessorsStatic": [],
                "output": [
            ...
            },
            {
                "description": "Description for t1",
                "filePath": str(Path("flypipe/catalog/catalog_core_test.py")),
                "importCmd": "from flypipe.catalog.catalog_core_test import t1",
                "nodeKey": "flypipe_catalog_catalog_core_test_function_t1_t1",
                "nodeType": "pandas",
                "name": "t1",
                "predecessors": [],
                "predecessorColumns": {},
            ...
            },
            {
                "description": "",
                "filePath": str(Path("flypipe/catalog/catalog_core_test.py")),
                "importCmd": "from flypipe.catalog.catalog_core_test import t3",
                "nodeKey": "flypipe_catalog_catalog_core_test_function_t3_t3",
                "nodeType": "pandas",
                "name": "t3",
                "predecessors": ["flypipe_catalog_catalog_core_test_function_t1_t1"],
                "predecessorColumns": {
                    "flypipe_catalog_catalog_core_test_function_t1_t1": []
                },
                "predecessorsStatic": [],
                "output": [],
                "successors": [],
